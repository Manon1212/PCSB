...
for i_trial in range(3):
	...
	angle = [0.43588989435, 1.78, 3.3166, 0.43588989435, 1.78, 3.3166, 0.43588989435, 1.78, 3.3166, 0.43588989435, 1.78, 3.3166, 0.43588989435, 1.78, 3.3166] #distance from the center corresponding to each angle shuffle
	angle = random.shuffle([angle])
	angle_choice = 
